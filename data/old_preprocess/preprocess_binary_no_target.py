...
#Itens count = 43098
# flat_list = [item for sublist in tra_seqs + tes_seqs for item in sublist]
# unique_count = len(set(flat_list))
# print("Number of unique occurrences:", unique_count)
...
if args.dataset == 'diginetica':
    ...
    pickle.dump(tra_seqs, open('diginetica_binary/train.txt', 'wb'))
    pickle.dump(tes_seqs, open('diginetica_binary/test.txt', 'wb'))
    pickle.dump(tra_seqs, open('diginetica_binary/all_train_seq.txt', 'wb'))
print('Done.')